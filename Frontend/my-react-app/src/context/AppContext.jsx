...
export function AuthProvider({ children }) {
  ...
  const login = (u) => {
    if (u.token) localStorage.setItem('ks_token', u.token)
    localStorage.setItem('ks_name', u.name)
    localStorage.setItem('ks_role', u.role)
    if (u.email) localStorage.setItem('ks_email', u.email)
    if (u.phone) localStorage.setItem('ks_phone', u.phone)
  ...
  const logout = () => {
    ;['ks_token', 'ks_name', 'ks_role', 'ks_email', 'ks_phone', 'ks_vehicle', 'ks_veh_type'].forEach(
